...
这些工作都使用了多种扩增操作，也没有分析单一操作的贡献。Chiyuan Zhang等人报告简单的随机裁剪可以大幅提升InceptionNet在ImageNet数据集上的识别率，从59.80%到67.18%。其他策略，例如调整图像的尺寸、对比度和光照等特性也可以产生一定的正则化效果。虽然没有系统的对比实验，但是经验告诉我们这些操作的提升远不如随机裁剪。裁剪操作的高度有效性是一个值得研究的课题。
